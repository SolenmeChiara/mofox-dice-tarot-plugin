...
1. 下载本仓库：
   ```bash
   git clone https://github.com/YOUR-USERNAME/mofox-dice-tarot-plugin.git
   ```
...
如遇到问题或有建议，请在 [GitHub Issues](https://github.com/YOUR-USERNAME/mofox-dice-tarot-plugin/issues) 提交。
